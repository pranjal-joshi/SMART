...
void setup() {
  ...
  // ConfigLoader::configData dummyData;
  // dummyData.ssid = "dummy1";
  // dummyData.pass = "dummy2";
  // dummyData.device_location = "workdesk";
  // dummyData.timeout = 65;
  // dummyData.url_off = "dummyoff";
  // dummyData.url_on = "dummyon";
  // configLoader.setConfig(&dummyData);
  configLoader.getConfig(&configData);
